...
- Explored the data using different visual analytics tools, including interactive maps and a `Plotly` [dashboard](http://spacexdashappkellibelcher.pythonanywhere.com/).
